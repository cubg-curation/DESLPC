...
See the file "runDemo.R" to perform the analysis on the demo dataset. Note that this script runs "enrich_original_reports.R", "create_meta_collection.R" and  "analyse_meta_collection.R" in order. 
...
- RedList_threatened_history.xlsx: used in Figure 2C for the history of of threatened plants within IUCN's Redl list.
